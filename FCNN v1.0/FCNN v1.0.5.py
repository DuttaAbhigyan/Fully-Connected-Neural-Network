...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 08 18:37:07 2018
...
#Initializer Methods
    ...
    def __init__(self, nodes, activation, alpha = None):       #alpha is the slope of negative part in leaky ReLu
...
#Backpropagation Through Neural Network, Updation of weights and  calculation of Downstream gradients            
    ...
    def updateWeights(self, learningRate):
        ...
        self.bias = self.bias - learningRate * self.biasGradient
...
class Neural_Network(layer, finalLayer):
    ...
    def __init__(self, layers, nodes, activations, errorFunction, alpha = None, 
